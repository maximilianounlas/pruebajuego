...
comida2=pygame.image.load('imagenes/manzana.PNG')
fondo=pygame.image.load('imagenes/manzana.PNG')
menu=pygame.image.load_extended("imagenes/fondo5.jpg")
conluz=pygame.image.load("imagenes/letra1.png")
sinluz=pygame.image.load("imagenes/letra2.png")
conluz1=pygame.image.load("imagenes/letra7.png")
